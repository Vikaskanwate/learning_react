            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className='text-left'>
                  ...
                  <p className='text-muted-foreground'>Creating responsive websites and webapplication with morden frameworks.</p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className='text-left'>
                  ...
                  <p className='text-muted-foreground'>Creating efficient backend application.</p>
                </div>
              </div>
            </div>
            <div className="gradient-border p-6 card-hover">
