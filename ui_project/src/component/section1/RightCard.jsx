  ...
  return (
    <div className='h-full overflow-hidden relative w-80  rounded-4xl'>
      ...
      <div className='absolute top-0 left-0 h-full w-full p-8 flex flex-col justify-between'>
        ...
        <div>
          <p className='text-lg leading-normal text-white mb-10'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, provident soluta sunt porro omnis.</p>
